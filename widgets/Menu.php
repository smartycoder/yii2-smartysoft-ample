...
class Menu extends \yii\widgets\Menu
{
    ...
    public $linkTemplate = '<a class="sidebar-link waves-effect waves-dark sidebar-link" href="{url}">{icon} {label} {badge}</a>';
    public $submenuTemplate = "\n<ul class='treeview-menu' {show}>\n{items}\n</ul>\n";
    public $activateParents = true;
    public $defaultIconHtml = '<i class="mdi mdi-adjust"></i> ';
    ...
    protected function renderItem($item)
    {
        ...
        if (isset($item['url'])) {
            ...
            $replace = !empty($item['icon']) ? [
                ...
                '{icon}' => '<i style="text-align:left" class="' . self::$iconClassPrefix . $item['icon'] . '"></i> ',
